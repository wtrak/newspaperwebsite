...
export const newspaperIssues = sqliteTable(
  "newspaper_issues",
  {
    ...
    monthDay: text("month_day").notNull().default(""),
    ...
    rightsBasis: text("rights_basis").notNull().default(""),
    rightsCheckedAt: text("rights_checked_at"),
    commercialUseStatus: text("commercial_use_status").notNull().default("Unreviewed"),
    catalogStatus: text("catalog_status").notNull().default("Archive lead"),
  ...
  (table) => [
    ...
    index("idx_newspaper_issues_month_day").on(table.monthDay),
    index("idx_newspaper_issues_headline").on(table.headline),
